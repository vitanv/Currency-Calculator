      ...
      option.push({
        ...
        label: (
          <div>
            {" "}
            <div
              className={"currency-flag currency-flag-" + list[i].toLowerCase()}
            ></div>
            <p>{list[i]}</p>
          </div>
        ),
      ...
      <div className="container" id="wraper">
        ...
        <div className="container" id="converter">
          ...
          <div className="output">
            ...
            <p>
              The rate is {this.state.rate} {this.state.to} to 1{" "}
              {this.state.from}
            </p>
          </div>
        </div>
